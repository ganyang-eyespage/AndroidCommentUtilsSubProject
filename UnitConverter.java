...
public class UnitConverter {
  ...
  public static final double KILOMETERS_IN_A_NAUTICAL_MILE =
      METERS_IN_A_NAUTICAL_MILE / METERS_IN_A_KILOMETER;

  public static final double MPS_TO_MPH = 2.236936292054;
  ...
  public static final int UNITS_MPS = 9; //m/s
   ...
   * </ul>
   */
  public static double convertSpeed(double originalSpeed, int originalUnits, int convertedUnits) {
    /** Check if conversion is not needed */
    if (originalUnits == convertedUnits) {
      return originalSpeed;
    }
    /** Check for km/h to mph conversion */
    if (originalUnits == UNITS_KPH && convertedUnits == UNITS_MPH) {
      return originalSpeed * MILES_IN_A_KILOMETER;
    }
    /** Check for mph to km/h conversion */
    if (originalUnits == UNITS_MPH && convertedUnits == UNITS_KPH) {
      return originalSpeed * KILOMETERS_IN_A_MILE;
    }
    /** Check for km/h to KN conversion */
    if (originalUnits == UNITS_KPH && convertedUnits == UNITS_KN) {
      return originalSpeed * KILOMETERS_IN_A_NAUTICAL_MILE;
    }

    /** Check for km/h to KN conversion */
    if (originalUnits == UNITS_MPS && convertedUnits == UNITS_MPH) {
      return originalSpeed * MPS_TO_MPH;
    }
   ...
   * </ul>
   */
  public static double convertLength(double originalLength, int originalUnits, int convertedUnits) {
    /** Check if conversion is not needed */
    if (originalUnits == convertedUnits) {
